...
define("DB_NAME", "restaurantinfo" ); 			// set database name
...
//reservation tables
define("TABLE_RESERVATION_FNAME_LENGTH",20);
define("TABLE_RESERVATION_SNAME_LENGTH",40);
define("TABLE_RESERVATION_EMAIL_LENGTH",128);
